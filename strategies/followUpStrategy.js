      ...
      innerSpeech: [
        {
          ...
          questions: [
            {
              text: '🎧 Ты действительно "слышал" эти слова внутренним голосом или просто знал их смысл?',
              clarifies: 'inner_speech_illusion',
              priority: 'high'
            },
            {
              text: '🗣 Если был голос - опиши его. Мужской? Женский? Твой? Чей-то другой?',
              clarifies: 'voice_characteristics',
              priority: 'medium'
            },
            {
              text: '📍 Где именно ты "слышал" этот голос? В голове? В ушах? В груди?',
